			...
			<ul>
				...
				<li class="principal">
					...
					<ul>
						...
						<li><a href="lista_usuarios.php"><i class="fas fa-clipboard-list"></i> Lista de Usuarios</a></li>
					</ul>
				</li>
				<?php }	?>
				<li class="principal">
					...
					<ul>
						...
						<li><a href="lista_clientes.php"><i class="fas fa-clipboard-list"></i> Lista de Clientes</a></li>
					</ul>
				</li>
